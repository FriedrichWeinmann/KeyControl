...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\KeyControl\functions", "$global:testroot\..\KeyControl\internal\functions"),
	
	[string]
	$ModuleName = "KeyControl",
...
$CommandPath = @(
    "$global:testroot\..\KeyControl\functions"
    "$global:testroot\..\KeyControl\internal\functions"
)
