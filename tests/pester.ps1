...
Remove-Module KeyControl -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\KeyControl\KeyControl.psd1"
Import-Module "$PSScriptRoot\..\KeyControl\KeyControl.psm1" -Force
